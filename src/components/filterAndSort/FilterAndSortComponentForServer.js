...
const FilterAndSortComponentForServer = observer(
  ({ parent, modalActive, setModalActive }) => {
    ...
    const inputHandler = (e) => {
      if (parent === "orders") {
        FilterAndSort.setFilters(
          {
            ...FilterAndSort.filters[ComponentFunction.Function],
      ...
      if (parent === "partners") {
        FilterAndSort.setPartnerFilters(
          {
            ...FilterAndSort.partnerFilters[ComponentFunction.Function],
            [e.target.name]: e.target.value,
          },
          ComponentFunction.Function
        );
      ...
      if (parent === "management_users") {
        FilterAndSort.setManagementFilters(
          {
    ...
    const resetFilters = () => {
      ...
      if (parent === "board") {
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, limit: 20 },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, searchString: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, selectedSort: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, city: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
        ...
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, side_type: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, load_capacity: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, thermo_bag: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, hydraulic_platform: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, side_loading: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, glass_stand: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, refrigerator_minus: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, refrigerator_plus: "" },
          "transports"
        );
        FilterAndSort.setBoardFilters(
          { ...FilterAndSort.boardFilters.transports, thermo_van: "" },
          "transports"
        );
        fetcher.setAdTransports(true);
      }
      if (parent === "management_users") {
        FilterAndSort.setManagementFilters(
          { ...FilterAndSort.managementFilters.users, role: "" },
          "users"
        );
        FilterAndSort.setManagementFilters(
          { ...FilterAndSort.managementFilters.users, city: "" },
          "users"
        );
        FilterAndSort.setManagementFilters(
          { ...FilterAndSort.managementFilters.users, delivery_group: "" },
          "users"
        );
        FilterAndSort.setManagementFilters(
          { ...FilterAndSort.managementFilters.users, searchString: "" },
          "users"
        );
    ...
    return (
      <div className={`filters_container`} style={{ flexDirection: "unset" }}>
        {parent === "management_users" && (
          <>
            {!searchActive ? (
              <img
                src={Setting.app_theme === "light" ? search : search_dark}
            ...
            {searchActive && (
              <input
                type="text"
                value={FilterAndSort.managementFilters.users.searchString}
                onChange={(e) => {
                  FilterAndSort.setManagementFilters(
                    {
                      ...FilterAndSort.managementFilters.users,
            ...
            {!searchActive && (
              <>
                ...
                <FilterSelect
                  ...
                  fieldName="role"
                  sortOptions={["all", "carrier", "customer", "driver"]}
                  filterSet="managementFilters"
                  inputHandler={inputHandler}
                />
            ...
            {FilterAndSort.managementFilters.users.city !== "all" ||
            FilterAndSort.managementFilters.users.city !== "" ||
            FilterAndSort.managementFilters.users.role !== "all" ||
            FilterAndSort.managementFilters.users.role !== "" ||
            FilterAndSort.managementFilters.users.delivery_group !== "all" ||
            FilterAndSort.managementFilters.users.delivery_group !== "" ||
            FilterAndSort.managementFilters.users.searchString !== "" ? (
              <img
                onClick={() => {
                ...
                src={
                  Setting.app_theme === "light" ? filter_off : filter_off_dark
                }
              />
            ) : (
              <></>
            ...
            <div className="vertical_filters_container">
              <div className="board_filters_selectors_container">
                <div className={`board_filters_selectors ${Setting.app_theme}`}>
                    ...
                    sortOptions={
                      ...
                      FilterAndSort.boardFilters.transports.load_capacity ===
                        ...
                        : FilterAndSort.boardFilters.transports
                          ...
                          FilterAndSort.boardFilters.transports
                            .load_capacity === "3"
                        ? [...TransportType.types.slice(5, 9)]
                        : FilterAndSort.boardFilters.transports.thermo_bag
                        ? [...TransportType.types.slice(1, 5)]
                        : !FilterAndSort.boardFilters.transports
                            .load_capacity &&
                          !FilterAndSort.boardFilters.transports.side_type
                        ? [...TransportType.types]
                        ...
                        : FilterAndSort.boardFilters.transports
                          ...
                          FilterAndSort.boardFilters.transports
                            .load_capacity === "20"
                        ? [...TransportType.types.slice(7, 8)]
                        : [...TransportType.types.slice(5, 10)]
                    }
                  ></FilterSelect>
                  ...
                  <>
                    {!FilterAndSort.boardFilters.transports.thermo_bag &&
                    FilterAndSort.boardFilters.transports.type !== "walk" &&
                    FilterAndSort.boardFilters.transports.type !== "car" &&
                    FilterAndSort.boardFilters.transports.type !==
                      "electric_scooter" &&
                    FilterAndSort.boardFilters.transports.type !== "scooter" &&
                    FilterAndSort.boardFilters.transports.type !== "bike" &&
                    FilterAndSort.boardFilters.transports.type !== "combi" ? (
                      <FilterSelect
                        ...
                        sortOptions={[...TransportType.load_capacities]}
                      />
                    ) : (
                      <></>
                    )}
                    ...
                    FilterAndSort.boardFilters.transports.type !== "combi" ? (
                      <FilterSelect
                        ...
                        sortOptions={
                          ...
                          FilterAndSort.boardFilters.transports
                            .refrigerator_plus
                            ? [...TransportType.side_types.slice(2, 3)]
                            : [...TransportType.side_types]
                        }
                      />
                    ) : (
                      <></>
                    ...
                    {(FilterAndSort.boardFilters.transports.thermo_bag
                      ...
                      : FilterAndSort.boardFilters.transports.side_loading ||
                        ...
                        FilterAndSort.boardFilters.transports
                          .refrigerator_plus ||
                        FilterAndSort.boardFilters.transports.hydraulic_platform
                      ? [...EquipmentType.types.slice(1, 9)]
                      : FilterAndSort.boardFilters.transports.load_capacity
                      ? [...EquipmentType.types.slice(2, 7)]
                      : !FilterAndSort.boardFilters.transports.type
                      ? [...EquipmentType.types]
                      : FilterAndSort.boardFilters.transports.type === "walk" ||
                        FilterAndSort.boardFilters.transports.type === "car" ||
                      ...
                      : FilterAndSort.boardFilters.transports.type ===
                          "combi" ||
                        FilterAndSort.boardFilters.transports.type === "minibus"
                      ? [...EquipmentType.types.slice(1, 4)]
                      : FilterAndSort.boardFilters.transports.type ===
                          "truck" &&
                        FilterAndSort.boardFilters.transports.side_type !==
                          "hard_top"
                      ? [...EquipmentType.types.slice(4, 7)]
        ...
        >
          <div className="scroll_content_container">
            ...
            {(user.user.role === "customer" &&
              ...
              parent !== "board") ||
            (user.user.role === "carrier" && parent !== "board") ? (
              <FilterInput
            ...
            {parent === "orders" ? (
              <>
                ...
                <FilterInput
                  ...
                  type={
                    FilterAndSort.filters[ComponentFunction.Function]
                      .timeFrom === "" && timeFromOnFocus === false
                      ? "text"
                      : timeFromOnFocus === true
                      ? "datetime-local"
                      : "datetime-local"
                  }
                ...
                <FilterSelect
                  ...
                  inputHandler={inputHandler}
                  defaultvalue={SetNativeTranslate(
                    Translate.language,
                    {},
                    "sorting"
                  )}
              ...
              <FilterSelect
                ...
                sortOptions={[
                  {
                    value: "default",
                    name: SetNativeTranslate(Translate.language, {}, "default"),
                  },
                  {
                    value: "name",
                    name: SetNativeTranslate(
