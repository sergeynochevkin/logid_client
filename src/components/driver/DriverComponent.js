...
import { FetcherContext, TranslateContext, UserContext, UserInfoContext } from '../..'
...
const DriverComponent = observer(() => {
    ...
    return (
        <>
            ...
            <Modal modalActive={modalActive} setModalActive={setModalActive} formReset={formReset} parent={'driverForm'}>
                <DriverForm files={files} pairs={pairs} setFiles={setFiles} setPairs={setPairs} setModalActive={setModalActive} formReset={formReset} formData={formData} setFormData = {setFormData}/>
            </Modal>
        </>
    )
})
