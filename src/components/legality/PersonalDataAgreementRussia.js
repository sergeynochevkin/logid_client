...
Настоящее согласие вступает в силу с момента его подтверждения мной на странице приложения, находящейся в сети интернет по адресу https://logid.app/registration  и действует в течение сроков, установленных действующим законодательством РФ.
          `],
          english: [`
          AGREEMENT
