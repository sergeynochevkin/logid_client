  ...
  ({
    ...
    const modalCloseAction = () => {
      if (
        ...
        parent === "createGroup" ||
        (parent === "OfferComponent" && user.user.role === "carrier")
      ) {
        formReset();
    ...
    return (
      ...
      >
        <div
          className={
            modalActive && Setting.app_theme === "light"
              ? "modalContent active"
              : modalActive && Setting.app_theme === "dark"
              ? "modalContent dark active"
