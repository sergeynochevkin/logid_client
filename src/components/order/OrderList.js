          ...
          <div className="scroll_content_container">
            <BookMark
              ...
              style={{
                ...
                cursor: ComponentFunction.Function === "new" && "default",
              }}
            >
            ...
            {user.user.role === "customer" ? (
              <BookMark
                ...
                style={{
                  ...
                  cursor:
                    ComponentFunction.Function === "postponed" && "default",
                }}
              >
                {SetNativeTranslate(
                  Translate.language,
                ...
                <div className="number_of_orders">
                  {order.totalCount.postponed}
                </div>
              </BookMark>
            ) : (
              <></>
            ...
            <BookMark
              ...
              style={{
                ...
                cursor: ComponentFunction.Function === "inWork" && "default",
              }}
            >
            ...
            <BookMark
              ...
              style={{
                ...
                cursor: ComponentFunction.Function === "completed" && "default",
              }}
            >
              {SetNativeTranslate(Translate.language, {}, "completed_bookmark")}
              <div className="number_of_orders">
                {order.totalCount.completed}
              </div>
            </BookMark>
            ...
            <BookMark
              ...
              style={{
                ...
                cursor: ComponentFunction.Function === "canceled" && "default",
              }}
            >
              {SetNativeTranslate(Translate.language, {}, "canceled_bookmark")}
              <div className="number_of_orders">
                {order.totalCount.canceled}
              </div>
            </BookMark>
            ...
            <BookMark
              ...
              style={{
                ...
                cursor: ComponentFunction.Function === "arc" && "default",
              }}
            >
            ...
            {user.user.role === "customer" ? (
              <BookMark
                ...
                style={{
                  ...
                  cursor: ComponentFunction.Function === "pattern" && "default",
                }}
              >
                {SetNativeTranslate(
                  Translate.language,
