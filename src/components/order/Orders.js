                ...
                <HorizontalContainer
                  style={{ marginTop: '10px' }}>
                  {
                    order.divided_orders[ComponentFunction.Function].map(oneOrder => <OrderItem
                      ...
                      driverInfo={((user.user.role === 'carrier' && oneOrder.driver_id !== UserInfo.userInfo.id) || user.user.role === 'customer') && oneOrder.order_status !== 'new' && oneOrder.order_status !== 'postponed' && oneOrder.order_status !== 'canceled' && oneOrder.order_status !== 'arc' ? Driver.drivers.find(el => el.user_info.id === oneOrder.driver_id).user_info : ''}
                    />)}
                </HorizontalContainer>
