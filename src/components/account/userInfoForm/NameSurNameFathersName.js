...
const NameSurNameFathersName = ({ formData, setFormData }) => {  
  ...
  return (
    <VerticalContainer
      style={{ gap: '0px' }}>
      <Input placeholder='Фамилия, имя, отчество' value={formData.name_surname_fathersname.value} onChange={(e) => formData.name_surname_fathersname.onChange(e)} onBlur={e => formData.name_surname_fathersname.onBlur(e)} type="name_surname_fathersname" name="name_surname_fathersname"
