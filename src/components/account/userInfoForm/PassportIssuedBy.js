    ...
    <VerticalContainer style={{ gap: "0px" }}>
      <Input
        placeholder={SetNativeTranslate(
          Translate.language,
          {},
          "passport_issued_by_place_holder"
        )}
        ...
        style={{
          borderLeft: formData.passport_issued_by.isEmpty
      ...
      >
        {(formData.passport_issued_by.isEmpty &&
          formData.passport_issued_by.isDirty) ||
        formData.passport_issued_by.minLengthError ||
        formData.passport_issued_by.maxLengthError
