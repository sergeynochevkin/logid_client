  ...
  return (
    <VerticalContainer
      ...
      <Input placeholder={SetTranslate(Translate.language,'passport_date_of_issue_place_holder')}
        ...
        name="passport_date_of_issue" id='passport_date_of_issue'
        style={{ borderLeft: formData.passport_date_of_issue.isEmpty ? 'solid 1px rgb(254, 111, 103,0.8)'  : '' }}
      ></Input>
      <FieldName
        style={{
          fontWeight: 'normal',
      ...
      >
        {formData.passport_date_of_issue.isEmpty && formData.passport_date_of_issue.isDirty ?
