...
const AddPartnerComponent = observer(() => {
  ...
  const partner_added = SetNativeTranslate(
    Translate.language,
    {},
    "partner_added"
  );
          ...
          Notification.addNotification([
            {
              id: v4(),
              type: "success",
              message: `${partner_added} ${data[0].partnerUserInfoId}`,
            },
          ]);
  ...
  return (
    <VerticalContainer style={{ alignItems: "center", gap: "30px" }}>
