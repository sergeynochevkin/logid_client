export const SetNativeTranslate = (language, phrase_object, service) => {
    ...
    let translation = [
        ...
        { service: 'city_adress', russian: 'Город и адрес', english: 'City and adress', spain: '', color: '', type: 'content' },
        ...
        { service: 'name_surname_fathersname_validation', russian: 'Фамилия, имя, отчество', english: 'First and last name', spain: '', color: '', type: 'validation' },
