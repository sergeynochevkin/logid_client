...
export default class TranslateStore {
    constructor() {
        ...
        this._translation = [
            ...
            { service: 'you_postponed', russian: 'Вы отложили', english: 'You postponed', spain: '', color: '', type: 'notification' },
            { service: 'you_canceled', russian: 'Вы отменили', english: 'You canceled', spain: '', color: '', type: 'notification' },
            { service: 'you_send', russian: 'Вы отправили', english: 'You send', spain: '', color: '', type: 'notification' },
            { service: 'you_took', russian: 'Вы взяли в работу', english: 'You took', spain: '', color: '', type: 'notification' },
            { service: 'you_finished', russian: 'Вы завершили', english: 'You finished', spain: '', color: '', type: 'notification' },
            { service: 'you_deleted', russian: 'Вы удалили', english: 'You deleted', spain: '', color: '', type: 'notification' },
            { service: 'you_moved_to_arc', russian: 'в ахиве', english: 'archived', spain: '', color: '', type: 'notification' },
            { service: 'you_opened', russian: 'Вы открыли', english: 'You opened', spain: '', color: '', type: 'notification' },
