...
export default class TranslateStore {
    constructor() {
        ...
        this._translation = [
            ...
            { service: 'password_notification', russian: 'пароль', english: 'password', spain: '', color: '', type: 'notification' },            
            ...
            { service: 'you_have_changed', russian: 'Вы изменили', english: 'You have changed', spain: '', color: '', type: 'notification' },
