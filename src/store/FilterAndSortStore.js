...
export default class FilterAndSortStore {
  constructor() {
    ...
    this._partnerFilters = localStorage.getItem("partnerFilters")
      ? JSON.parse(localStorage.getItem("partnerFilters"))
      : {
          partners: {
            id: "",
            partnerName: "",
    ...
    this._boardFilters = localStorage.getItem("boardFilters")
      ? JSON.parse(localStorage.getItem("boardFilters"))
      : {
          transports: {
            limit: 30,
            main_limit: 5,
    ...
    this._managementFilters = localStorage.getItem("managementFilters")
      ? JSON.parse(localStorage.getItem("managementFilters"))
      : {
          users: {
            role: "",
            city: "",
  ...
  setPartnerFilters(value, option) {
    ...
    localStorage.setItem(
      "partnerFilters",
      JSON.stringify(this._partnerFilters)
    );
  }
  ...
  setManagementFilters(value, option) {
    ...
    localStorage.setItem(
      "managementFilters",
      JSON.stringify(this._managementFilters)
    );
  }
