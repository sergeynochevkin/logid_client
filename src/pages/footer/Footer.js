...
const Footer = observer(() => {
  ...
  const items = [
    ...
    { id: 3, icon: '', name: 'support@logid.app', description: '', section_id: 1, class: 'footer_email' },
    {
      id: 5, icon: '', name: Adress.country.value === 'russia' ? SetNativeTranslate(Translate.language, {
