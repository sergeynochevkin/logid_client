  ...
  let sections = [
    ...
    },
    {
      id: 2, header: SetNativeTranslate(Translate.language, {
        ...
        russian: ['Мы предаставляем все опции для любого уровня пописки. Уровни подписки настроены для разных типов пользователей нашего сервиса'],
