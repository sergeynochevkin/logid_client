  ...
  let sections = [
    {
      ...
      header_comment: SetNativeTranslate(Translate.language, {
        russian: [
          "Сервис для заказчиков, курьеров, перевозчиков, диспетчеров и логистов",
        ],
        english: [
          "Service for customers, couriers, carriers, dispatchers and logisticians",
        ],
        spanish: [
          "Servicio para clientes, mensajeros, transportistas, despachadores y logísticos",
        ],
        turkish: [
          "Müşterilere, kuryelere, nakliyecilere, dağıtım görevlilerine ve lojistikçilere yönelik hizmet",
        ],
          ...
          <div className={`admin_console_container ${Setting.app_theme}`}>
            {Management.visits.month > 0 ? (
              <>
                <AdminConsoleItem
                  plan={70}
                  currentRate={Management.visits.toDay}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
                ...
                <AdminConsoleItem
                  plan={490}
                  currentRate={Management.visits.week}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
                ...
                <AdminConsoleItem
                  plan={2170}
                  currentRate={Management.visits.month}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
            ...
            {Management.registrations.month > 0 ? (
              <>
                <AdminConsoleItem
                  plan={5}
                  currentRate={Management.registrations.toDay}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
                ...
                <AdminConsoleItem
                  plan={35}
                  currentRate={Management.registrations.week}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
                ...
                <AdminConsoleItem
                  plan={150}
                  currentRate={Management.registrations.month}
                  comment={SetNativeTranslate(
                    Translate.language,
                    {
            ...
            <AdminConsoleItem
              ...
              influence={"positive"}
              plan={
                Management.orders.filter((el) => el.order_status === "new")
                  .length
              }
              currentRate={
                Management.orders.filter((el) => el.order_status === "new")
            ...
            <AdminConsoleItem
              ...
              influence={"positive"}
              plan={
                Management.orders.filter((el) => el.order_status === "inWork")
                  .length
              }
              currentRate={
                Management.orders.filter((el) => el.order_status === "inWork")
            ...
            <AdminConsoleItem
              ...
              influence={"positive"}
              plan={
                Management.orders.filter(
                  (el) => el.order_status === "completed"
                ).length
              }
              currentRate={
                Management.orders.filter(
