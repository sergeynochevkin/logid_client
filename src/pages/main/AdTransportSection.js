          ...
          {SetNativeTranslate(Translate.language,
            {
              ...
              сhinese: ['您想在这里看看您的交通工具吗？ 注册、添加交通和照片、填写广告文字并打开显示屏。 请等待审核。 现在免费了！'],
              hindi: ['क्या आप यहां अपना परिवहन देखना चाहेंगे? रजिस्टर करें, परिवहन और तस्वीरें जोड़ें, विज्ञापन टेक्स्ट भरें और डिस्प्ले चालू करें। कृपया मॉडरेशन के लिए प्रतीक्षा करें. अब यह मुफ़्त है!'],
            })}
        </div>
      </div>
    </>
