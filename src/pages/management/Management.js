...
const Admin = observer(() => {
  ...
  return (
    <div
      className={`page_container ${Setting.app_theme}`}
    ...
    >
      ...
      >
        <div className="scroll_content_container">
          <BookMark
            ...
            style={{
              color:
                ComponentFunction.PageFunction === "admin_statistics" && "grey",
            }}
          >
          ...
          <BookMark
            ...
            style={{
              color:
                ComponentFunction.PageFunction === "admin_orders" && "grey",
            }}
          >
            {SetNativeTranslate(Translate.language, {
              russian: ["Заказы"],
          ...
          <BookMark
            ...
            style={{
              color:
                ComponentFunction.PageFunction === "admin_transports" && "grey",
            }}
          >
            {SetNativeTranslate(Translate.language, {
              russian: ["Транспорт"],
          ...
          <BookMark
            ...
            style={{
              color:
                ComponentFunction.PageFunction === "admin_settings" && "grey",
            }}
          >
            {SetNativeTranslate(Translate.language, {
              russian: ["Настройки"],
          ...
          <BookMark
            ...
            style={{
              color:
                ComponentFunction.PageFunction === "admin_account" && "grey",
            }}
          >
            {SetNativeTranslate(Translate.language, {
              russian: ["Аккаунт"],
      ...
      {ComponentFunction.PageFunction === "admin_users" ? (
        <Users />
      ) : ComponentFunction.PageFunction === "managers" ? (
        <Managers />
      ) : ComponentFunction.PageFunction === "admin_statistics" ? (
        <Statistics />
      ) : ComponentFunction.PageFunction === "admin_settings" ? (
        <Settings />
      ) : ComponentFunction.PageFunction === "admin_account" ? (
        <Account />
      ) : ComponentFunction.PageFunction === "admin_orders" ? (
        <Orders />
      ) : ComponentFunction.PageFunction === "admin_transports" ? (
        <ManagementTransportComponent />
      ) : (
        <></>
      )}
    </div>
