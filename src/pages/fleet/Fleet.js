...
const Fleet = observer(() => {
  ...
  let sections = [
    {
      ...
      header_comment: SetNativeTranslate(Translate.language, {
        russian: [
          "Мы предаставляем все опции для любого уровня подписки. Уровни подписки настроены для разных типов пользователей нашего сервиса",
        ],
        english: [
          "We provide all options for any subscription level. Subscription levels are configured for different types of users of our service",
        ],
        spanish: [
          "Ofrecemos todas las opciones para cualquier nivel de suscripción. Los niveles de suscripción están personalizados para diferentes tipos de usuarios de nuestro servicio",
        ],
        turkish: [
          "Her abonelik düzeyi için tüm seçenekleri sunuyoruz. Abonelik seviyeleri, hizmetimizin farklı kullanıcı türleri için özelleştirilmiştir",
        ],
        сhinese: [
          "我们为任何订阅级别提供所有选项。 订阅级别是针对我们服务的不同类型的用户定制的",
        ],
        hindi: [
          "हम किसी भी सदस्यता स्तर के लिए सभी विकल्प प्रदान करते हैं। हमारी सेवा के विभिन्न प्रकार के उपयोगकर्ताओं के लिए सदस्यता स्तर अनुकूलित किए गए हैं",
        ],
      }),
      description: "",
      class: "even",
    ...
    },
    {
      ...
      header_comment: SetNativeTranslate(Translate.language, {
        ...
        spanish: [
          "Ofrecemos todas las opciones para cualquier nivel de suscripción. Los niveles de suscripción están configurados para diferentes tipos de usuarios de nuestro servicio",
        ],
        сhinese: [
          "我们为任何订阅级别提供所有选项。 订阅级别是针对我们服务的不同类型的用户定制的",
        ],
        ...
        turkish: [
          "Her abonelik düzeyi için tüm seçenekleri sunuyoruz. Abonelik seviyeleri, hizmetimizin farklı kullanıcı türleri için yapılandırılmıştır",
        ],
      }),
      description: "",
      class: "even",
  ...
  const items = [
    {
      id: 1,
      icon: Setting.app_theme === "light" ? route : route_dark,
    ...
    {
      id: 2,
      icon: Setting.app_theme === "light" ? flag : flag_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 3,
      icon: Setting.app_theme === "light" ? group_add : group_add_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 4,
      icon: Setting.app_theme === "light" ? like_up_down : like_up_down_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 6,
      icon: Setting.app_theme === "light" ? list : list_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 7,
      icon: Setting.app_theme === "light" ? point_status : point_status_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 8,
      icon: Setting.app_theme === "light" ? alert : alert_dark,
      name: SetNativeTranslate(Translate.language, {
        russian: ["Уведомления"],
    ...
    {
      id: 9,
      icon: Setting.app_theme === "light" ? on_map : on_map_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 10,
      icon: Setting.app_theme === "light" ? filter : filter_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 14,
      icon: Setting.app_theme === "light" ? location_icon : location_icon_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 15,
      icon: Setting.app_theme === "light" ? city : city_dark,
      name: SetNativeTranslate(Translate.language, {
    ...
    {
      id: 16,
      icon: Setting.app_theme === "light" ? transport : transport_dark,
      name: SetNativeTranslate(Translate.language, {
