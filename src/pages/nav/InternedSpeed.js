    ...
    return (
        <>
            <div className='internet_speed_container'>
                <img className='internet_speed_icon' src={
                    Setting.app_theme === 'light' ? (!link.internet ? network_off : link.internet_speed < 5 ? network_low : link.internet_speed < 20 ? network_middle : network_full)
                        :
                        (!link.internet ? network_off_dark : link.internet_speed < 5 ? network_low_dark : link.internet_speed < 20 ? network_middle_dark : network_full_dark)
                }></img>
